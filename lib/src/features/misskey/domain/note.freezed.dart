...
mixin _$Note {
 ...
 String get id; DateTime get createdAt; String? get userId; MisskeyUser? get user; String? get text; String? get cw; List<String> get fileIds; List<Map<String, dynamic>> get files; String? get replyId; String? get renoteId; Note? get reply; Note? get renote; Map<String, int> get reactions; int get renoteCount; int get repliesCount; String? get visibility; bool get localOnly; String? get myReaction;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,createdAt,userId,user,text,cw,const DeepCollectionEquality().hash(fileIds),const DeepCollectionEquality().hash(files),replyId,renoteId,reply,renote,const DeepCollectionEquality().hash(reactions),renoteCount,repliesCount,visibility,localOnly,myReaction);

@override
String toString() {
  return 'Note(id: $id, createdAt: $createdAt, userId: $userId, user: $user, text: $text, cw: $cw, fileIds: $fileIds, files: $files, replyId: $replyId, renoteId: $renoteId, reply: $reply, renote: $renote, reactions: $reactions, renoteCount: $renoteCount, repliesCount: $repliesCount, visibility: $visibility, localOnly: $localOnly, myReaction: $myReaction)';
}
...
@useResult
$Res call({
 String id, DateTime createdAt, String? userId, MisskeyUser? user, String? text, String? cw, List<String> fileIds, List<Map<String, dynamic>> files, String? replyId, String? renoteId, Note? reply, Note? renote, Map<String, int> reactions, int renoteCount, int repliesCount, String? visibility, bool localOnly, String? myReaction
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  DateTime createdAt,  String? userId,  MisskeyUser? user,  String? text,  String? cw,  List<String> fileIds,  List<Map<String, dynamic>> files,  String? replyId,  String? renoteId,  Note? reply,  Note? renote,  Map<String, int> reactions,  int renoteCount,  int repliesCount,  String? visibility,  bool localOnly,  String? myReaction)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Note() when $default != null:
return $default(_that.id,_that.createdAt,_that.userId,_that.user,_that.text,_that.cw,_that.fileIds,_that.files,_that.replyId,_that.renoteId,_that.reply,_that.renote,_that.reactions,_that.renoteCount,_that.repliesCount,_that.visibility,_that.localOnly,_that.myReaction);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  DateTime createdAt,  String? userId,  MisskeyUser? user,  String? text,  String? cw,  List<String> fileIds,  List<Map<String, dynamic>> files,  String? replyId,  String? renoteId,  Note? reply,  Note? renote,  Map<String, int> reactions,  int renoteCount,  int repliesCount,  String? visibility,  bool localOnly,  String? myReaction)  $default,) {final _that = this;
switch (_that) {
case _Note():
return $default(_that.id,_that.createdAt,_that.userId,_that.user,_that.text,_that.cw,_that.fileIds,_that.files,_that.replyId,_that.renoteId,_that.reply,_that.renote,_that.reactions,_that.renoteCount,_that.repliesCount,_that.visibility,_that.localOnly,_that.myReaction);case _:
  throw StateError('Unexpected subclass');
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,createdAt,userId,user,text,cw,const DeepCollectionEquality().hash(_fileIds),const DeepCollectionEquality().hash(_files),replyId,renoteId,reply,renote,const DeepCollectionEquality().hash(_reactions),renoteCount,repliesCount,visibility,localOnly,myReaction);
