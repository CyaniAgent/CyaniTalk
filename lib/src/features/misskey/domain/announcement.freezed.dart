...
class _Announcement implements Announcement {
  const _Announcement({required this.id, required this.createdAt, required this.updatedAt, this.title, this.text, this.imageUrl, this.needConfirmationToRead = false, this.isRead = false, this.reads,  List<String>? userIds}): _userIds = userIds;
