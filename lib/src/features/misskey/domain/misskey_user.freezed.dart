...
as Map<String, String>?,followedMessage: freezed == followedMessage ? _self.followedMessage : followedMessage // ignore: cast_nullable_to_non_nullable
...
@override@JsonKey() List<Map<String, dynamic>> get fields {
