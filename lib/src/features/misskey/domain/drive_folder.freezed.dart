...
mixin _$DriveFolder {
 ...
 String get id; DateTime get createdAt; String get name; String? get parentId;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DriveFolder&&(identical(other.id, id) || other.id == id)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.name, name) || other.name == name)&&(identical(other.parentId, parentId) || other.parentId == parentId));
}
...
@useResult
$Res call({
 String id, DateTime createdAt, String name, String? parentId
});
...
/// Create a copy of DriveFolder
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? createdAt = null,Object? name = null,Object? parentId = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  DateTime createdAt,  String name,  String? parentId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DriveFolder() when $default != null:
return $default(_that.id,_that.createdAt,_that.name,_that.parentId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  DateTime createdAt,  String name,  String? parentId)  $default,) {final _that = this;
switch (_that) {
case _DriveFolder():
return $default(_that.id,_that.createdAt,_that.name,_that.parentId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  DateTime createdAt,  String name,  String? parentId)?  $default,) {final _that = this;
switch (_that) {
case _DriveFolder() when $default != null:
return $default(_that.id,_that.createdAt,_that.name,_that.parentId);case _:
  return null;
...
class _DriveFolder implements DriveFolder {
  const _DriveFolder({required this.id, required this.createdAt, required this.name, this.parentId});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DriveFolder&&(identical(other.id, id) || other.id == id)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.name, name) || other.name == name)&&(identical(other.parentId, parentId) || other.parentId == parentId));
}
...
/// Create a copy of DriveFolder
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? createdAt = null,Object? name = null,Object? parentId = freezed,}) {
